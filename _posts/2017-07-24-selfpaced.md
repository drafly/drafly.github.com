...
机器学习方法中也存在相关方法用于选择样本，例如：主动学习（active learning）和协同训练（co-training）。自步学习与二者的区别在于自步学习每次选择置信度高的样本，而主动学习倾向于选择当前模型下确定性或置信度低的样本，协同训练虽然也是选择置信度高的样本，但是该方法一般应用于半监督学习框架，其中某些样本缺少类别标签。而自步学习中样本的标签是完全存在的，属于监督学习。
