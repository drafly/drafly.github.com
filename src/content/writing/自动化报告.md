...
knitr可以很方便的生成报告是因为采用markdown的编程范式，对于markdown的使用可以参考我之前的文档[link](http://www.hanlongfei.com/博客搭建/2014/12/15/markdown/)，也可参考另一篇中文的MarkDown语法说明[link](http://www.appinn.com/markdown/)。knitr已经包含代码高亮，所以就不需要采用我介绍的那种代码高亮的方式。
