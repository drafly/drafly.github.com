---
title: "凸优化-对偶问题"
description: "凸优化系列：拉格朗日对偶、对偶函数与对偶问题，强弱对偶条件与几何解释。"
...
\text{subject to} & \quad -A^Tu -G^Tv = c \\
& \quad v \leq 0
\end{aligned}
$$
...
\text{subject to} & \quad \xi \geq 0, \, i=1,\ldots,n \\
...
\text{subject to} & \quad 0 \leq w \leq CI, \, w^Ty=0
\end{aligned}
$$
